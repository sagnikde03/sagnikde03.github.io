...
Education
======
* B.Tech in Electronics and Communication Engineering, University of Calcutta, Kolkata, 2021–2025
* Minor in Business Administration, Indian Institute of Technology, Patna, 2023-25
...
* Large Language Models: Pre-training, Fine-tuning, RAG, Agentic AI, LLM Agents, Tool Calling, Function Calling, Multi-Agent Systems, LLM Evaluation and Benchmarking
* Agentic AI & Orchestration: LangGraph, CrewAI, Claude Agent SDK, Google Agent Development Kit (ADK), DSPy, Agent Workflows, Multi-Agent Orchestration
* RAG & Knowledge Systems: Hybrid RAG, Agentic RAG, Retrieval Pipelines, Vector Databases, Chroma
* Frameworks & Libraries: PyTorch, TensorFlow, Keras, vLLM, LangChain, NiBabel, OpenCV, Sci-Kit Learn, Pillow, Flask
